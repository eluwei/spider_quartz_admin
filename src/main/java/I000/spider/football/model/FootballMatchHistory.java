...
public class FootballMatchHistory implements Serializable{
	...
	private Integer footballMatchHistoryId;
	...
	public Integer getFootballMatchHistoryId() {
		return footballMatchHistoryId;
	}
	public void setFootballMatchHistoryId(Integer footballMatchHistoryId) {
		this.footballMatchHistoryId = footballMatchHistoryId;
	}
